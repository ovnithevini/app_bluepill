...
<p><Link to="/addMedicamento" className="btn btnsuccess">Adicionar um novo Medicamento</Link></p>
...
<button
onClick={()=>handleDelete(medicamento.id)} className="btn btndanger">Deletar</button>
</td>
</tr>
)})
}
